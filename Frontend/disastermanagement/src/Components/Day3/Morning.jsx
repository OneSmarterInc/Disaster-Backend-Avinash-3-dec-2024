        ...
        >
          <Flex h={"88vh"}>
                    ...
                    return (
                      <Tooltip
                        label={
                          ...
                          (el.name === "Raj Patel" && "") ||
                          (el.name === "Grace Patterson" && "") || (el.name === "Aisha Patel" && "COO")
                        }
                      >
            ...
            >
              ...
              >
                <Text fontSize={"20"}>
                  Morning light filters into the office, casting a soft glow on
                  the tired face of Ben Carter. He's on a teleconference with
