      ...
      <Modal isOpen={isOpen} onClose={onClose} size={"4xl"}>
        ...
        <ModalContent>
          ...
          <ModalBody fontFamily={"Fredoka"}>
            <Text fontWeight={"600"} fontSize={isMobile ? 11 : 25} textAlign={"justify"}>
            ...
            <VStack alignItems={"left"}>
              <Text fontWeight={"600"} fontSize={isMobile ? 10 : 25} mt={10}>
                1. Organizational Culture and Dynamics:
              </Text>
              <Text fontWeight={"600"} fontSize={isMobile ? 10 : 25}>
                Trust and Autonomy:
              </Text>
              <UnorderedList fontSize={isMobile ? 10 : 25}>
                <ListItem>
