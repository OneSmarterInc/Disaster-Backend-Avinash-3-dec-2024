  ...
  return (
    <>
      ...
      >
        ...
        >
          <Text fontSize={"20"}>
            It was a typical February Monday night, and the CIO is just about to
            leave the office. when he received a call inviting him to a
            conference call concern a problem at the data center.
          </Text>
        </Box>
        <Box
          w={"90%"}
          ...
          <TransitionGroup>
                ...
                >
                  <Box
                    ...
                    className={`message ${messageClass} ${
                      el.sender === "Ben Carter" ? "BenCarter" : "KateSullivan"
                    }`}
                  >
                    <Box border={"0px solid red"} w={"70%"}>
                      <Box
                        ...
                        border={"0px solid black"}
                        bgColor={
                          el.sender === "Ben Carter" ? "#030405" : "#f0f0f0"
                        }
            ...
            {showBox && (
              <>
                ...
                <Flex
                  onClick={() =>
                    handleClick("Do you take the vendors recommendation?")
                  }
                  className="box"
                  ...
                  cursor={"pointer"}
                >
                  <Text>A : Do you take the vendors recommendation?</Text>
                </Flex>

                <Flex
                  onClick={() =>
                    handleClick("What other things do you consider?")
                  }
                  className="box"
                  border={"1px solid gray"}
                  w={"50%"}
                  ...
                  cursor={"pointer"}
                >
                  <Text>B : What other things do you consider?</Text>
                </Flex>
                ...
                >
                  <Text>
                    C : Do you escalate higher through the vendor management for
                    a better solution?
                  </Text>
                </Flex>
                ...
                <Flex
                  onClick={() => handleClick("What do you tell your customer?")}
                  className="box"
                  border={"1px solid gray"}
                  w={"50%"}
                  m={"auto"}
                ...
                <Flex
                  onClick={() =>
                    handleClick(
                      "Do you have to make a statement Wall Street? You are a Fortune 500 company.?"
                    )
                  }
                  className="box"
                  border={"1px solid gray"}
                ...
                >
                  <Text>
                    G : Do you have to make a statement Wall Street? You are a
                    Fortune 500 company.?
                  </Text>
                </Flex>
